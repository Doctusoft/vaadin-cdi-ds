...
/**
 * JaasAccessControl is an {@link AccessControl} implementation that also provides set of JAAS helper methods to login
 * and out the user as well as to query additional information.
 * 
 * In order to use JaasAccessControl a proper security domain must be configured in the underlying application server.
 */
@Default
public class JaasAccessControl extends AccessControl implements Serializable {
     ...
     * @param username
     * @param password
     * @throws ServletException if login fails or current session has already been authenticated
     */
